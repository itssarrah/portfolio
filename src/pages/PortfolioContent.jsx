...
<div className="relative w-80 h-80 mx-auto mb-16 group animate-float">
  {/* Outer rotated background layer */}
  <div 
    className="absolute inset-0 transform rotate-45 rounded-[3rem] shadow-2xl transition-all duration-500 group-hover:rotate-[50deg] group-hover:scale-105"
    style={{ background: `linear-gradient(135deg, ${colors.primary}, ${colors.accent})` }}
  ></div>

  {/* Mid translucent glow layer */}
  <div 
    className="absolute inset-4 transform rotate-45 rounded-[3rem] bg-white shadow-inner opacity-40"
  ></div>

  {/* Profile picture layer */}
  <div className="absolute inset-8 rounded-full overflow-hidden border-4 border-white shadow-xl transition-transform duration-500 group-hover:scale-110">
    <img 
      src="Pic.jpg" 
      alt="Sarra Arab"
...
<style>
  ...
  `}
              ...
              <h2 className="text-2xl text-gray-800 mb-2" style={{ fontFamily: 'Gloock, serif' }}>
...
>
  ...
  <span>Download CV</span>
            ...
            <div className="max-w-4xl mx-auto">
              <p className="text-lg text-gray-900 leading-relaxed mb-12 " style={{ fontFamily: 'Montserrat, sans-serif' }}>
